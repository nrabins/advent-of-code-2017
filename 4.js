const input = `sayndz zfxlkl attjtww cti sokkmty brx fhh suelqbp
...
let validCount = lines.filter(line => {
...
console.log(validCount + " valid passphrases under policy 1");

validCount = lines.filter(line => {
    // alphabetize words to make comparison later a check for anagrams
...
console.log(validCount + " valid passphrases under policy 2");